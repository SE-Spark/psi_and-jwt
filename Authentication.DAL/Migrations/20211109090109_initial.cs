        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrimeDate = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    StationNo = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalID = table.Column<int>(nullable: false),
                    PassPortNo = table.Column<int>(nullable: false),
                    Allegation = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    AllegationDate = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
